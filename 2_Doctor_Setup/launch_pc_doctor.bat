@echo off
title APML Connect Pro - Doctor Consultation PC Launcher
echo ===================================================
echo   APML Connect Pro - Doctor Consultation PC Launcher
echo ===================================================
echo.
...
echo.
echo Launching Doctor Consultation Console...
...
timeout /t 2 >nul
start http://%SERVER_IP%:3002/dashboard/doctor
exit
