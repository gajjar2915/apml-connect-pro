@echo off
title APML Connect Pro - Pharmacy Counter PC Launcher
echo ===================================================
echo   APML Connect Pro - Pharmacy Counter PC Launcher
echo ===================================================
echo.
...
echo.
echo Launching Pharmacy Counter Console...
...
timeout /t 2 >nul
start http://%SERVER_IP%:3003/dashboard/pharmacy
exit
