...
export default function PharmacyLoginPage() {
  ...
  const [activeRole, setActiveRole] = useState<RoleKey>('pharmacy');
  const [loginEmail, setLoginEmail] = useState(roleConfigs.pharmacy.defaultEmail);
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (activeRole === 'pharmacy') {
      if (loginPassword === '12345' || loginPassword.length >= 4) {
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between p-12 bg-gradient-to-br from-blue-950 via-slate-900 to-slate-950 border-r border-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-xl space-y-6 relative z-10 my-auto">
          ...
          <p className="text-slate-400 text-sm leading-relaxed">
            Fulfill digital prescriptions, verify medicine inventory stock, scan barcodes, and manage automatic dispensing logs.
          </p>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 bg-slate-900">
        <div className="w-full max-w-md space-y-6">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs mt-1">Sign in for prescription fulfillment, inventory stock & dispensing.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4 text-left">
            <div>
              ...
              <input
                ...
                required
                placeholder="e.g. pharmacy@clinic.com"
